...
Figure~\ref{pap:generals:sec:eval:fig:baseline} show our initial performance results for the manycore code generated by our backend without added optimizations in the \pull~direction as described in Section~\ref{sec:method:sub:baseline}.
...
\begin{figure}[h!]
    \centering
    \subfloat[SSSP]{\includegraphics[scale=0.6]{graphit-figures/sssp-block.pdf}} \\
    \subfloat[BFS]{\includegraphics[scale=0.6]{graphit-figures/bfs-block.pdf}}
...
\begin{figure}[h!]
    \centering
    \subfloat[SSSP]{\includegraphics[scale=0.6]{graphit-figures/sssp-cache.pdf}} \\
    \subfloat[BFS]{\includegraphics[scale=0.6]{graphit-figures/bfs-cache.pdf}}
...
\begin{figure}[h]
    ...
    \caption{Scaling results \todo{finish up this caption}} 
