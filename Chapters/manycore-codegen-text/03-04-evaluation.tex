...
\begin{figure}[!ht]
    \centering
    \subfloat[SSSP]{\includegraphics[scale=0.6]{graphit-figures/sssp-block.pdf}\label{thesis:sec:eval:fig:block:sssp}} \\
    \subfloat[BFS]{\includegraphics[scale=0.6]{graphit-figures/bfs-block.pdf}\label{thesis:sec:eval:fig:block:bfs}}
