...
\begin{table}[h]
  ...
  \begin{footnotesize}
    \begin{tabular}{DE}
      \toprule
      {\bf Cores} & 128 cores in a 16x8 grid \\
      & RISC-V 32-bit IMAF ISA @ 1 GHz\\
      & 4KB Instruction Cache \\
      & 4KB Data Scratchpad \\ %%[.5ex]
      \midrule
      {\bf Cache} & 128KB Total Capacity \\
      & 32 Independent Cache Banks \\
      & 8-way Set Associative\\ [.2ex]
      \midrule
      {\bf NoC} & Bidirectional 2D Mesh NoC (32-bit data, 64-bit address) \\ [.2ex]
      \midrule
      {\bf Memory} & 2 HBM2 memory channels \\
      & 32 GB/s per channel \\
      & 512 MB per channel \\
      \bottomrule
    \end{tabular}
...
%\hline
Graph & DRAM Stalls & Bandwidth &  Speedup \\ \hline
LJ & 0.78 & 3.03 & 1.19    \\
HW &  0.79 & 2.17 & 1.53   \\
PC & 0.83 & 3.02 & 1.49     \\
\end{tabular}
