...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{graphit-figures/non-blocked.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.5]{graphit-figures/blocked.pdf}
...
\begin{figure*}[t!]
    \centering
    \subfloat[Non-Blocked Accesses]{\includegraphics[scale=0.5]{graphit-figures/non-blocked.pdf}}
    \qquad
    \subfloat[Blocked Accesses]{\includegraphics[scale=0.5]{graphit-figures/blocked.pdf}}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{graphit-figures/edge-aware.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{graphit-figures/push_v_pull_fig.pdf}
