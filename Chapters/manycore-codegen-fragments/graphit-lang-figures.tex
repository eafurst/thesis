...
\begin{figure}[ht]
    ...
    \caption{The CSR graph format that we use to store graph data on the manycore. For weighted graphs, the weight is stored as a tuple with each element in the edge array.}
