...
\begin{figure}[t]
    ...
    \caption{The Unified GraphIt Compiler framework (\GG). \graphisa decouples the hardware-independent part of the compiler from the hardware-dependent \graphvms. Grey blocks denote parts of the compiler, and blue blocks denote code (inputs, intermediates, libraries, or generated).}
    \label{fig:ugf}
\end{figure}
}