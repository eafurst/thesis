...
The original hybrid traversal method proposed by Beamer et al. involves two different heuristic conditions. 
...
\[ m_f > \frac{m_u}{\alpha}\]
The second condition is to switch back to the \push direction is:
\[ n_f < \frac{n}{\beta}\]
