...
In this thesis, I focus on two different aspects of the problem of efficiently utilizing the manycore for graph processing: ease of programming and manycore specific optimizations. 
